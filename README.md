...
FP_Animation existed originally under the FP_Utility distribution, it's now been moved out externally to avoid other problems in later development.
This package is a set of quick tools to help with things like simple IK Rigging, Spline Navigation, and Injection of various .anim files.
